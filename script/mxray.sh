...
echo -e ""
echo -e "================================="
echo -e "${cy}🔹DIGI BOOSTER 6/12🔹${NC} "
echo -e ""
echo -e ""
echo -e "\`\`\`"
echo -e "${digiboost2}"
...
echo -e ""
echo -e "================================="
echo -e "${cy}🔹MAXIS FREEZE XHTTP🔹${NC} "
echo -e ""
echo -e ""
echo -e "\`\`\`"
echo -e "${maxisfrez}"
